...
<br></br><br></br>
The First Community driven NFTS with proposed future utilties<br></br><br></br>
    ...
    <Panel header="What is The Pups?" defaultExpanded>
    <s.TextP style={{textAlign: "left"}}>
    The Pups are pixel art images, generated algorithmically. Most are Apes-looking, but there are a few rarer types mixed in: Traits. Every Pups has their own profile page that shows their attributes as well as their ownership.
          </s.TextP>
    </Panel>
    <Panel header="How can I mint">
    <s.TextP style={{textAlign: "left"}}>
    1.Download and install a Chrome browser plugin called MetaMask. This will allow websites (that you authorize) access to your Pulsechain account.
    2.If you made a new account, buy some PLS. The MetaMask plugin has a button that will allow you to buy PLS from different CEX.
    3.Once you have the plugin installed, this website will recognize it and add buttons that allow you buy/mint The Pups directly in the interface.
    
          </s.TextP>
    </Panel>
    <Panel header="What Is Pulsechain">
    <s.TextP style={{textAlign: "left"}}>
    PulseChain is a new blockchain which means to copy the Ethereum state and add some scalability improvements. It calls itself the "largest airdrop ever."
          </s.TextP>
    </Panel>
    <Panel header="Where does the market data on this site come from?">
    <s.TextP style={{textAlign: "left"}}>
    The prices you see on this site are loaded from the The Pups contract on the Pulsechain. Because the The Pups pre-date the ERC-721 standard (and all third party NFT marketplaces) we also needed to write a market so the The Pups could be transacted. We have no control over the contract governing this market, and have no access to any additional data beyond what the blockchain provides. In fact anyone else could write a web front end for it.
          </s.TextP>
    </Panel>
  </PanelGroup>
            </s.SecContainer>
